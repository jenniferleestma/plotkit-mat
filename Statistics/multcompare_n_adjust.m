function [comparison,means,h,gnames] = multcompare_n_adjust(stats,n_comparisons, varargin)
...
% -----------------------------------------------
function [crit,pval] = getcrit(ctype,alpha,df,ng,t,C,alternative,approx,n_comparisons)
